<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdManagement.aspx.cs" Inherits="advertiseManegement.AdManagement" %>
        ...
        <%--<div class="container-fluid header-bar">
            <div class="row">
                ...
                <div class="col-sm-10 text-right">
                    ...
                    <a href="admindashboard.aspx" style="padding: 10px; color: white;">Manage User</a> | 
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="scrollable-grid">
               <asp:GridView ID="GridViewAds" runat="server" CssClass="table table-bordered"
    AutoGenerateColumns="False" DataKeyNames="id" OnRowCommand="GridViewAds_RowCommand"
...
<div class="footer-bar">
     <p style="font-size:20px;">Copyright &copy; 2014-
